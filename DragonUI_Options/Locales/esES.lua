...
L["Show the average item level of equipped gear on the character and inspect panels."] = "Mostrar el nivel de objeto medio del equipo en los paneles de personaje e inspección."
...
L["Use class colors for party member nameplates instead of the friendly player color."] = "Usa colores de clase para las placas de los miembros del grupo en lugar del color de jugador aliado."
...
L["Show Level In Name When Targeted"] = "Mostrar nivel en el nombre al tener objetivo"
...
L["Opacity for non-target nameplates when fade is enabled (0.0 to 1.0)."] = "Opacidad de placas no objetivo cuando el desvanecimiento está activado (0.0 a 1.0)."
...
L["Show numeric values (current / percent) on the power bar."] = "Muestra los valores numéricos (actual / porcentaje) en la barra de poder."
L["Power Bar Players Only"] = "Barra de poder solo en jugadores"
...
L["Show cast bars on party member nameplates even when not targeted."] = "Muestra las barras de casteo en las placas de los miembros del grupo aunque no estén seleccionados."
...
L["Uses the combat log to guess casts on units you are not targeting. Less accurate than target, focus, mouseover, and arena enemies above."] = "Usa el registro de combate para inferir casteos en unidades que no tienes como objetivo. Menos preciso que objetivo, foco, mouseover y enemigos en arena."
...
L["Show raid target markers (skull, cross, star, etc.) on nameplates."] = "Muestra los marcadores de objetivo de banda (calavera, cruz, estrella, etc.) en las placas."
...
L["Show elite/rare dragon icon on nameplates."] = "Muestra el icono de dragón de élite/raro en las placas."
...
L["Show combo points on the current target nameplate."] = "Muestra los puntos de combo en la placa del objetivo actual."
...
L["Show totem icon on shaman totem nameplates."] = "Muestra el icono del tótem en las placas de tótems de chamán."
L["Display"] = "Visualización"
L["General"] = "General"
L["Cast Bar"] = "Barra de casteo"
L["Bars"] = "Barras"

-- Secciones nuevas/reorganizadas (refresh UX de placas)
...
L["Colored glow indicating aggro status (red = tanking, orange = losing, yellow = gaining)."] = "Resplandor de color indicando estado de amenaza (rojo = tanqueando, naranja = perdiendo, amarillo = ganando)."
L["Tank Mode"] = "Modo Tanque"
L["Inverts threat colors for a tank: green means you hold aggro, red means you lost it."] = "Invierte los colores de amenaza para un tanque: verde significa que mantienes el aggro, rojo que lo has perdido."
L["DPS Mode"] = "Modo DPS"
...
L["Keep all nameplates fully opaque when you have a target."] = "Mantiene todas las placas completamente opacas cuando tienes un objetivo."
L["Opacity for non-target nameplates when fade is enabled (0.1 - 1.0)."] = "Opacidad de placas no objetivo con desvanecimiento activado (0.1 - 1.0)."
...
L["Totem Click Padding"] = "Padding de clic en tótems"
L["Extra clickable padding on totem nameplates (easier to click)."] = "Padding extra clicable en placas de tótem (más fácil de clicar)."
L["Clamp Target to Screen"] = "Fijar objetivo en pantalla"
L["Keep the target nameplate visible at the top of the screen. Extends WorldFrame height when enabled."] = "Mantiene visible la placa del objetivo en pantalla."
L["Clamp Bosses to Screen"] = "Fijar jefes en pantalla"
L["Keep boss nameplates visible at the top of the screen inside party and raid instances."] = "Mantiene visibles las placas de jefes (nivel calavera / ??)."
L["Clamp Top Inset"] = "Margen superior de fijado"
L["Distance below the top edge where clamped nameplates stop."] = "Distancia bajo el borde superior donde se detienen las placas fijadas."
L["Clickbox"] = "Área clicable"
L["Clickbox Width Factor"] = "Factor de ancho del clickbox"
L["Clickbox Height Factor"] = "Factor de alto del clickbox"
L["Scales the nameplate clickbox relative to its original size. Recommended to change this setting while out of combat."] = "Escala el área clicable respecto a su tamaño original. Se recomienda cambiarlo fuera de combate."
L["Show Clickbox"] = "Mostrar clickbox"
L["Displays the box selection space (clickbox) of nameplates."] = "Muestra el espacio de selección (clickbox) de las placas."
...
L["Name and health percent font scale (1-10, default 2)."] = "Escala de fuente del nombre y porcentaje de salud (1-10, predeterminado 2)."
L["Only apply Retail-like stacking inside party and raid instances. It remains disabled in the open world, battlegrounds, and arenas."] = "Aplica el apilado estilo Retail solo en mazmorras y bandas. Permanece desactivado en el mundo abierto, campos de batalla y arenas."
L["Scales the nameplate clickbox relative to its original size. Changes made during combat are applied when combat ends."] = "Escala el área de clic de la placa respecto a su tamaño original. Los cambios realizados en combate se aplican al terminar."
L["Show icons for recognized shaman totems. DragonUI uses localized spell names and automatically learns your own active totems."] = "Muestra iconos para tótems de chamán reconocidos. DragonUI usa los nombres localizados de los hechizos y aprende automáticamente tus tótems activos."
...
L["Hover the coins in your bags to list the gold of every character that has logged in with DragonUI."] = "Pasa el ratón por las monedas de las bolsas para ver el oro de cada personaje que haya iniciado sesión con DragonUI."
L["Show a tooltip with your other characters' gold when hovering the money in bags."] = "Muestra un tooltip con el oro de tus otros personajes al pasar el ratón por el dinero de las bolsas."
...
L["An ally carries dozens of auras, so you pick below what earns a slot."] = "Un aliado lleva decenas de auras, así que abajo eliges qué merece sitio."
