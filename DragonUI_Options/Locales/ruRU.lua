...
L["Style"] = "Стиль"
L["Gryphon Scale"] = "Масштаб грифонов"
L["Gryphon Offset X"] = "Смещение грифонов по X"
L["Gryphon Offset Y"] = "Смещение грифонов по Y"
L["Moves both gryphons inward or outward, mirrored left/right."] = "Перемещает обоих грифонов внутрь или наружу, зеркально слева и справа."
L["Old"] = "Старый"
L["New"] = "Новый"
L["Flying"] = "Летящий"
...
L["Ally Aura List"] = "Список аур союзников"
L["Always Highlight These Spells"] = "Всегда выделять эти заклинания"
L["Always Show Crowd Control"] = "Всегда показывать контроль"
L["Always Show Defensive Cooldowns"] = "Всегда показывать защитные способности"
L["Always Show Others' Crowd Control"] = "Всегда показывать чужой контроль"
L["An ally carries dozens of auras, so only what you list here is shown."] = "На союзнике десятки аур, поэтому показывается только то, что указано здесь."
L["Any other buff has to be listed here, or an ally in a raid fills the screen."] = "Любой другой положительный эффект нужно указать здесь, иначе союзник в рейде заполнит экран."
L["Aura Horizontal Offset"] = "Смещение по горизонтали"
L["Aura Icon Size"] = "Размер значка"
L["Aura Row"] = "Ряд аур"
L["Aura Vertical Offset"] = "Смещение по вертикали"
L["Blizzard's dispel colors, editable below."] = "Цвета рассеивания Blizzard, изменяемые ниже."
L["Border Colors"] = "Цвета рамки"
L["Buff List"] = "Список положительных эффектов"
L["Buffs and debuffs share these slots."] = "Положительные и отрицательные эффекты делят эти места."
L["Buffs share the row with debuffs, ordered by priority."] = "Положительные эффекты делят ряд с отрицательными, по приоритету."
L["Colored Aura Borders"] = "Цветные рамки аур"
L["Cooldown Font Size"] = "Размер шрифта таймера"
L["Cooldown Swipe Style"] = "Стиль заливки"
L["Cooldown Text Position"] = "Положение таймера"
L["Crowd Control"] = "Контроль"
L["Crowd Control + List"] = "Контроль + список"
L["Curse"] = "Проклятие"
L["Debuff List"] = "Список отрицательных эффектов"
L["Defensive Buff List"] = "Список защитных эффектов"
L["Disease"] = "Болезнь"
L["Enemy Buffs"] = "Эффекты врага"
L["Enemy crowd control matters no matter who cast it."] = "Контроль важен, кто бы его ни наложил."
L["Enrage"] = "Ярость"
L["Every debuff, not just crowd control. Useful for spotting what to dispel."] = "Все отрицательные эффекты, не только контроль. Удобно, чтобы видеть, что рассеивать."
L["Friendly Plates"] = "Таблички союзников"
L["Hide auras on every nameplate except your target and focus."] = "Скрывать ауры на всех табличках, кроме цели и фокуса."
L["Highlight Size"] = "Размер выделения"
L["Highlighted Auras"] = "Выделенные ауры"
L["Highlighted auras draw larger than the rest."] = "Выделенные ауры рисуются крупнее остальных."
L["Icon Order"] = "Порядок значков"
L["Importance"] = "Важность"
L["Importance: crowd control first, then enemy defensives, then your own debuffs."] = "Важность: сначала контроль, затем защитные способности врага, затем ваши эффекты."
L["Magic"] = "Магия"
L["Max Aura Icons"] = "Максимум значков"
L["Modern Icon Border"] = "Современная рамка"
L["Modern Icon Border Debuff Desc"] = "Обрамляет значки аур рамкой панели команд DragonUI."
L["Multiplier over the base icon size."] = "Множитель к базовому размеру."
L["No Dispel Type"] = "Без типа рассеивания"
L["Nothing"] = "Ничего"
L["Order Icons By"] = "Сортировать значки по"
L["Poison"] = "Яд"
L["Purgeable & Defensive"] = "Рассеиваемые и защитные"
L["Radial sweep over the icon as it runs out."] = "Круговая заливка значка по мере истечения."
L["Separate Color for Crowd Control"] = "Отдельный цвет для контроля"
L["Show All Debuffs"] = "Показывать все отрицательные эффекты"
L["Show Auras"] = "Показывать ауры"
L["Show Auras on Allies"] = "Показывать ауры союзников"
L["Show Cooldown Swipe"] = "Показывать заливку"
L["Show Cooldown Text"] = "Показывать таймер"
L["Show Enemy Buffs"] = "Показывать эффекты врага"
L["Show buffs and debuffs above nameplates."] = "Показывать положительные и отрицательные эффекты над табличками."
L["Shows buffs you can dispel or steal, plus the defensive cooldowns listed here."] = "Показывает эффекты, которые можно рассеять или украсть, и защитные из списка ниже."
L["Spell List Only"] = "Только список"
L["Stuns, fears and polymorphs on an ally, listed or not."] = "Оглушения, страхи и превращения на союзнике, в списке или нет."
L["Stuns, fears, roots and polymorphs are detected automatically. Add anything the game does not flag."] = "Оглушения, страхи, обездвиживание и превращения определяются автоматически. Добавьте сюда то, что игра не отмечает."
L["Time Remaining"] = "Оставшееся время"
L["Time Remaining: whatever expires soonest goes first."] = "Оставшееся время: первым идёт то, что закончится раньше."
L["Time left on each icon."] = "Оставшееся время на каждом значке."
L["Timers"] = "Таймеры"
L["Uses the defensive buff list from the Enemy Buffs section."] = "Использует список защитных эффектов из раздела эффектов врага."
L["What Gets Highlighted"] = "Что выделяется"
L["Which Buffs"] = "Какие эффекты"
L["An ally carries dozens of auras, so you pick below what earns a slot."] = "На союзнике десятки аур, поэтому ниже вы выбираете, что заслуживает места."
L["Debuffs on the Ally"] = "Отрицательные эффекты на союзнике"
L["Buffs the Ally Carries"] = "Положительные эффекты союзника"
L["Also Show These Spells"] = "Показывать также эти заклинания"
L["Listed spells always show, buff or debuff, on top of everything above."] = "Заклинания из списка показываются всегда, положительные или отрицательные, вдобавок ко всему выше."
