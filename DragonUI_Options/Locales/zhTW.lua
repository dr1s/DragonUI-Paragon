...
L["Style"] = "樣式"
L["Gryphon Scale"] = "獅鷲縮放"
L["Gryphon Offset X"] = "獅鷲水平偏移"
L["Gryphon Offset Y"] = "獅鷲垂直偏移"
L["Moves both gryphons inward or outward, mirrored left/right."] = "將兩側獅鷲向內或向外移動，左右鏡像對稱。"
L["Old"] = "舊樣式"
L["New"] = "新樣式"
L["Flying"] = "飛行"
...
-- Alt Gold
L["Alt Gold"] = "其他角色金幣"
L["Enable Alt Gold"] = "啟用其他角色金幣"
L["Hover the coins in your bags to list the gold of every character that has logged in with DragonUI."] = "將滑鼠移到揹包的金幣上，即可列出所有使用 DragonUI 登入過的角色的金幣。"
L["Show a tooltip with your other characters' gold when hovering the money in bags."] = "將滑鼠移到揹包金錢上時，顯示包含其他角色金幣的提示。"
L["Show All Realms"] = "顯示所有伺服器"
L["List characters from every realm instead of only the realm you are playing on."] = "列出所有伺服器的角色，而不僅是當前伺服器。"

-- Nameplate aura section
L["Ally Aura List"] = "友方光環列表"
L["Always Highlight These Spells"] = "總是突顯這些法術"
L["Always Show Crowd Control"] = "總是顯示控場效果"
L["Always Show Defensive Cooldowns"] = "總是顯示防禦技能"
L["Always Show Others' Crowd Control"] = "總是顯示他人的控場效果"
L["An ally carries dozens of auras, so only what you list here is shown."] = "一名隊友身上有數十個光環，因此只顯示這裡列出的內容。"
L["Any other buff has to be listed here, or an ally in a raid fills the screen."] = "其他增益必須在此列出，否則團隊中的隊友會佔滿螢幕。"
L["Aura Horizontal Offset"] = "水平偏移"
L["Aura Icon Size"] = "圖示大小"
L["Aura Row"] = "光環列"
L["Aura Vertical Offset"] = "垂直偏移"
L["Blizzard's dispel colors, editable below."] = "暴雪的驅散顏色，可在下方修改。"
L["Border Colors"] = "邊框顏色"
L["Buff List"] = "增益列表"
L["Buffs and debuffs share these slots."] = "增益與減益共用這些位置。"
L["Buffs share the row with debuffs, ordered by priority."] = "增益與減益共用一列，依優先順序排列。"
L["Colored Aura Borders"] = "彩色光環邊框"
L["Cooldown Font Size"] = "剩餘時間字型大小"
L["Cooldown Swipe Style"] = "冷卻掃描樣式"
L["Cooldown Text Position"] = "剩餘時間位置"
L["Crowd Control"] = "控場效果"
L["Crowd Control + List"] = "控場效果 + 列表"
L["Curse"] = "詛咒"
L["Debuff List"] = "減益列表"
L["Defensive Buff List"] = "防禦性增益列表"
L["Disease"] = "疾病"
L["Enemy Buffs"] = "敵方增益"
L["Enemy crowd control matters no matter who cast it."] = "無論由誰施放，控場效果都很重要。"
L["Enrage"] = "激怒"
L["Every debuff, not just crowd control. Useful for spotting what to dispel."] = "所有減益，不只是控場效果。方便查看需要驅散什麼。"
L["Friendly Plates"] = "友方名條"
L["Hide auras on every nameplate except your target and focus."] = "除了目標與焦點外，隱藏所有名條上的光環。"
L["Highlight Size"] = "突顯大小"
L["Highlighted Auras"] = "突顯的光環"
L["Highlighted auras draw larger than the rest."] = "突顯的光環會比其他光環更大。"
L["Icon Order"] = "圖示順序"
L["Importance"] = "重要性"
L["Importance: crowd control first, then enemy defensives, then your own debuffs."] = "重要性：先是控場效果，接著是敵方防禦技能，再是你自己的減益。"
L["Magic"] = "魔法"
L["Max Aura Icons"] = "最大光環圖示數"
L["Modern Icon Border"] = "現代圖示邊框"
L["Modern Icon Border Debuff Desc"] = "以 DragonUI 快捷列邊框為光環圖示加框。"
L["Multiplier over the base icon size."] = "相對基礎大小的倍數。"
L["No Dispel Type"] = "無驅散類型"
L["Nothing"] = "無"
L["Order Icons By"] = "圖示排序方式"
L["Poison"] = "中毒"
L["Purgeable & Defensive"] = "可驅散與防禦性"
L["Radial sweep over the icon as it runs out."] = "圖示隨時間流逝的環形掃描。"
L["Separate Color for Crowd Control"] = "控場效果使用獨立顏色"
L["Show All Debuffs"] = "顯示所有減益"
L["Show Auras"] = "顯示光環"
L["Show Auras on Allies"] = "在隊友身上顯示光環"
L["Show Cooldown Swipe"] = "顯示冷卻掃描"
L["Show Cooldown Text"] = "顯示剩餘時間"
L["Show Enemy Buffs"] = "顯示敵方增益"
L["Show buffs and debuffs above nameplates."] = "在名條上方顯示增益與減益。"
L["Shows buffs you can dispel or steal, plus the defensive cooldowns listed here."] = "顯示你可以驅散或偷取的增益，以及下方列出的防禦技能。"
L["Spell List Only"] = "僅法術列表"
L["Stuns, fears and polymorphs on an ally, listed or not."] = "隊友身上的昏迷、恐懼與變形，無論是否在列表中。"
L["Stuns, fears, roots and polymorphs are detected automatically. Add anything the game does not flag."] = "昏迷、恐懼、定身與變形會自動辨識。請在此加入遊戲未標記的法術。"
L["Time Remaining"] = "剩餘時間"
L["Time Remaining: whatever expires soonest goes first."] = "剩餘時間：最先結束的排在最前。"
L["Time left on each icon."] = "每個圖示上的剩餘時間。"
L["Timers"] = "計時"
L["Uses the defensive buff list from the Enemy Buffs section."] = "使用敵方增益區塊中的防禦性增益列表。"
L["What Gets Highlighted"] = "突顯哪些光環"
L["Which Buffs"] = "哪些增益"
L["An ally carries dozens of auras, so you pick below what earns a slot."] = "一名隊友身上有數十個光環，因此在下方選擇哪些值得顯示。"
L["Debuffs on the Ally"] = "隊友身上的減益"
L["Buffs the Ally Carries"] = "隊友擁有的增益"
L["Also Show These Spells"] = "另外顯示這些法術"
L["Listed spells always show, buff or debuff, on top of everything above."] = "列表中的法術總是顯示，無論增益或減益，並疊加在以上設定之上。"
